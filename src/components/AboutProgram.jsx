...
const showTitleWork1 = () => {
        setWork_p1(`
        1.Программа Work and Travel – это программа культурного международного обмена, которая собирает сотни тысяч студентов со всего мира в США во время летних каникул, в период с мая
...
const showTitleWork2 = () => {
        setWork_p2(`
        2.Программа Work and Travel – это программа культурного международного обмена, которая собирает сотни тысяч студентов со всего мира в США во время летних каникул, в период с мая
        по сентябрь. Уникальность программы состоит в том, что каждый студент сможет реализовать несколько целей одновременно: познакомиться с традициями и культурой США, получить международный опыт работы, улучшить уровень владения английским языком путем каждодневного общения с носителями языка и, в то же время, совершить увлекательное путешествие
        по всем 50 штатам и округу Колумбия. Каждый студент сможет открыть для себя свою Америку, выбрав свой маршрут путешествия по Национальным паркам Монтаны или Калифорнии,
        в захватывающий дух Гранд Каньон, в неспящий Лас Вегас, экзотические Гавайские Острова, а может быть устроит утреннюю пробежку в Центральном Парке.
        `);
...
const showTitleWork3 = () => { 
        setWork_p3(`
        3.Программа Work and Travel – это программа культурного международного обмена, которая собирает сотни тысяч студентов со всего мира в США во время летних каникул, в период с мая
        по сентябрь. Уникальность программы состоит в том, что каждый студент сможет реализовать несколько целей одновременно: познакомиться с традициями и культурой США, получить международный опыт работы, улучшить уровень владения английским языком путем каждодневного общения с носителями языка и, в то же время, совершить увлекательное путешествие
        по всем 50 штатам и округу Колумбия. Каждый студент сможет открыть для себя свою Америку, выбрав свой маршрут путешествия по Национальным паркам Монтаны или Калифорнии,
        в захватывающий дух Гранд Каньон, в неспящий Лас Вегас, экзотические Гавайские Острова, а может быть устроит утреннюю пробежку в Центральном Парке.
        `);
    ...
    function showTitleWork4(){
        setWork_p4(`
        4.Программа Work and Travel – это программа культурного международного обмена, которая собирает сотни тысяч студентов со всего мира в США во время летних каникул, в период с мая
        по сентябрь. Уникальность программы состоит в том, что каждый студент сможет реализовать несколько целей одновременно: познакомиться с традициями и культурой США, получить международный опыт работы, улучшить уровень владения английским языком путем каждодневного общения с носителями языка и, в то же время, совершить увлекательное путешествие
        по всем 50 штатам и округу Колумбия. Каждый студент сможет открыть для себя свою Америку, выбрав свой маршрут путешествия по Национальным паркам Монтаны или Калифорнии,
        в захватывающий дух Гранд Каньон, в неспящий Лас Вегас, экзотические Гавайские Острова, а может быть устроит утреннюю пробежку в Центральном Парке.
        `);
    ...
    return(
        <div className="MAIN">
            ...
            <div className="AboutProgram_footer">
              <Footer/>
            </div>
        </div>
    )
